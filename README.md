...
- **MLOps & Infrastructure:** Slashing deployment times through CI/CD pipelines (GitHub Actions), Docker, and self-managed Kubernetes (EKS/GKE) endpoints.
- **Cloud Engineering:** Designing cost-effective, scalable architectures and migrating massive infrastructure across GCP, AWS, and Azure.
...
### 📊 GitHub Metrics
<div align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com?user=Srushanth&theme=radical&hide_border=true" alt="GitHub Streak" />
</div>

---

### ⚡ Recent Career Highlights
- **Engineered an advanced RAG platform** using Llama-Index RouterEngine, expanding platform capabilities and boosting processing efficiency by 40%.
- **Optimized LLM infrastructure** by enabling GPU utilization for Docker containers on EKS, increasing computational efficiency by 60%.
- **Re-architected deployment pipelines** transitioning from SageMaker to self-managed EKS endpoints, cutting deployment times by 800% and saving 80% in infrastructure costs.
- **Led end-to-end migrations** of massive ML services (EC2, S3, EKS) across major cloud providers (AWS to GCP) while maintaining 99.99% uptime.
